<template>
  ...
  -->
      <li  @click="$bus.$emit('stopInterval')" v-show="menu.home === 'true'" v-bind:class="{ active : route.path === '/dashboard'}">
          <router-link to="/dashboard">
              <i class="material-icons">home</i> Home
          </router-link>
      </li>
      <li  @click="$bus.$emit('stopInterval')" v-show="menu.wallet === 'true'" v-bind:class="{ active : route.path === '/wallet'}">
          <router-link to="/wallet">
              <i class="material-icons">account_balance_wallet</i> Wallet
          </router-link>
      </li>
      <li @click="$bus.$emit('stopInterval')" v-show="menu.mining === 'true'" v-bind:class="{ active : route.path === '/mining'}">
          <router-link to="/mining" role="tab" data-toggle="tab">
              <i class="material-icons">gavel</i> Miner
          </router-link>
      </li>
      <li  @click="$bus.$emit('stopInterval')" v-show="menu.system === 'true'" v-bind:class="{ active : route.path === '/system'}">
          <router-link to="/system">
              <i class="material-icons">info</i> System
          </router-link>
      </li>
      <li @click="$bus.$emit('stopInterval')" v-bind:class="{ active : route.path === '/settings'}">
