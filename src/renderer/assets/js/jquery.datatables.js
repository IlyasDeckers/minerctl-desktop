...
*/
(function (c) {
  typeof define === 'function' && define.amd ? define(['jquery', 'datatables.net'], function (l) {
    return c(l, window, document)
  }) : typeof exports === 'object' ? module.exports = function (l, k) {
    l || (l = window)
  ...
  var m = c.fn.dataTable,
    j = function (a, b) {
      ...
      this.s.dt.settings()[0].responsive || (b && typeof b.details === 'string' ? b.details = {
        type: b.details
  ...
  c.extend(j.prototype, {
    _constructor: function () {
      ...
      d.oApi._fnCallbackReg(d, 'aoRowCreatedCallback', function (e) {
        c.inArray(!1, a.s.current) !== -1 && c('td, th', e).each(function (e) {
    ...
    _columnsVisiblity: function (a) {
      var b = this.s.dt,
        ...
        h = c.map(d, function (b) {
          return b.auto && b.minWidth === null ? !1 : !0 === b.auto ? '-' : c.inArray(a, b.includeIn) !== -1
        }),
        n = 0
      e = 0
      ...
      for (f = g.length; e < f; e++) {
        var i = g[e].columnIdx
        h[i] === '-' && (!d[i].control && d[i].minWidth) && (n || b - d[i].minWidth < 0 ? (n = !0, h[i] = !1) : h[i] = !0, b -= d[i].minWidth)
      }
      g = !1
      e = 0
      ...
      e = 0
      for (f = d.length; e < f; e++) d[e].control && (h[e] = g); c.inArray(!0, h) === -1 && (h[0] = !0)
      return h
    },
    _classLogic: function () {
      var a = this,
        ...
        f = function (a, b) {
          var d = e[a].includeIn; c.inArray(b, d) === -1 && d.push(b)
        },
        g = function (c, d, i, g) {
          if (i) {
            if (i === 'max-') {
              ...
              if (i === 'not-') {
                d = 0
                for (i = b.length; d < i; d++) b[d].name.indexOf(g) === -1 && f(c, b[d].name)
              }
            }
    ...
    _detailsInit: function () {
      var a = this,
        ...
        d = this.c.details
      d.type ===
            'inline' && (d.target = 'td:first-child, th:first-child')
      b.on('draw.dtr', function () {
        a._tabIndexes()
      })
      a._tabIndexes()
      ...
      var e = d.target
      c(b.table().body()).on('click.dtr mousedown.dtr mouseup.dtr', typeof e === 'string' ? e : 'td, th', function (d) {
    ...
    _resizeAuto: function () {
      var a = this.s.dt,
        b = this.s.columns
      if (this.c.auto && c.inArray(!0, c.map(b, function (a) {
        return a.auto
      })) !== -1) {
        a.table().node()
    ...
    _tabIndexes: function () {
      ...
      c(typeof e === 'number' ? ':eq(' + e + ')' : e, a.rows({
        page: 'current'
      ...
      return function (b, d, e) {
        if (d) c('div.dtr-modal-content').empty().append(e())
          ...
          c(k).on('keyup.dtr', function (a) {
            a.keyCode === 27 && (a.stopPropagation(), f())
          })
        }
  ...
  o.register('responsive.hasHidden()', function () {
    ...
    return a._responsive ? c.inArray(!1, a._responsive.s.current) !== -1 : !1
  })
  j.version = '2.1.0'
  c.fn.dataTable.Responsive = j
  c.fn.DataTable.Responsive = j
  c(k).on('preInit.dt.dtr', function (a, b) {
    if (a.namespace === 'dt' && (c(b.nTable).hasClass('responsive') ||
